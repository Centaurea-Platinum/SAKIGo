{
  ...
  "notes": [
    ...
    "Merged register/global-head input width is derived as register_count * expanded_channel.",
    "The per-head q/kv channel is derived as bottleneck_channel / q_heads.",
  ...
  "models": {
    ...
    "model2": {
      ...
      "trunk": {
        ...
        "register_gather_blocks": [1, 8, 16],
        "register_broadcast_blocks": [1, 8, 16],
        "q_heads": 4,
        "kv_heads": 2,
        "global_rope_frequencies": ["pi"],
        "local_rope_frequencies": ["pi/2"]
