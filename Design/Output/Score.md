...
The active mixed-small-board suite gives normalized smooth-L1 a constant loss
weight of 81 so the shared-trunk score gradient remains substantial and
comparable across the 7×7, 8×8, and 9×9 records. Report MAE in board points by
converting each record with its actual board area.
