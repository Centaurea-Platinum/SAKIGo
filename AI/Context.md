...
- [sakigo/CONTRACTS.md](../sakigo/CONTRACTS.md) - versioned contracts: strict record schemas v1/v2, prepared format v3, checkpoint schema 8, model/loss semantics, and run-dir layout.
